...
public class TextureAtlasKeys {
    ...
    public static String SCREEN_MEMU_TITLE = "menuIcon";
    ...
    public static String PLAYSCREEN_BACKGROUND = "playscreen";
    public static String PLAYSCREEN_QUESTIONSTEMBACKGROUND = "questionStemBackground";
    public static String PLAYSCREEN_OPTIONBUTTON = "optionButton";
    public static String PLAYSCREEN_ZACAMUSUME_Q = "zacamusume_Q";
    public static String PLAYSCREEN_SKILLBUTTONUSEOUT = "skillButtonUseOut";
    public static String PLAYSCREEN_SKILLBUTTON_TEMPLATE = "skillButton(%s)";
    public static String PLAYSCREEN_AUDIO = "audio";
    public static String pLAYSCREEN_CURRENTTEAMSIGN_BLACK = "currentTeamSign_BLACK";
    public static String PLAYSCREEN_PAUSEBUTTON = "pause";
    public static String PLAYSCREEN_EMPTY_BUTTON = "systemButton";
    public static String PLAYSCREEN_EXITBUTTON = "systemButtonExit";
